...
class AccountingEntityTester (object):
...
class TestRequest (AccountingEntityTester):
...
class TestAllocation (AccountingEntityTester):
...
class TestCreditLimit (AccountingEntityTester):
...
class TestHold (AccountingEntityTester):
    
    def setup (self):
        AccountingEntityTester.setup(self)
